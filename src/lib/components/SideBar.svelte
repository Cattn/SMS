...
<div class="flex items-center justify-center">
	<div
		class="bg-primary-container fixed top-5 left-5 flex h-[95%] flex-col items-center justify-between rounded-4xl p-2"
	>
		<div class="mt-3 mb-3 flex flex-col items-center justify-center gap-2">
			...
			<div class="button-mod mt-5 flex flex-col items-center justify-center gap-2">
				...
				<div class="flex flex-col items-center justify-center">
					...
					<h1 class="text-on-secondary roboto-flex-home-link">Browse</h1>
				</div>
				<div class="flex flex-col items-center justify-center">
					<Button
						variant="tonal"
